...
// We need to test for a minimum version of PHP, 
// because earlier versions have bugs that affect security, 
// and ARGON2ID hashing algorithm
if (version_compare(PHP_VERSION, '7.3.0') < 0){
    throw new Exception(
        'This system needs PHP 7.3.0 or later'
    );
}
